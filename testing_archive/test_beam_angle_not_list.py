...
"""
Experiment fault: 
    beam_angle not a list
Expected exception:
    Slice must specify beam_angle that must be a list of numbers \(ints or floats\) which are angles
    of degrees off boresight \(positive E of N\)
"""
