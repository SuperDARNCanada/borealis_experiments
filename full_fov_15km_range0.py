#!/usr/bin/python
"""
full_fov_15km_range0
~~~~~~~~~~~~~~~~~~~~
The mode transmits with a pre-calculated phase progression across the array which illuminates the
full FOV, and receives on all antennas. This mode uses 15-km range gates for high spatial
resolution, starting at range gate 0.
