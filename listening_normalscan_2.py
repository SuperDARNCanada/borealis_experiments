...
Normalscan with a second slice for listening on a separate frequency simultaneously. The beam
direction of the receive frequency is always offset from the transmit frequency
...
class ListeningNormalscan2(ExperimentPrototype):
    ...
    def __init__(self):
        super().__init__(
            comment_string="Normalscan with a second slice for listening on a separate frequency "
            "simultaneously. The beam direction of the receive frequency is always offset "
