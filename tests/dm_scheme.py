...
class FinalStageRxRateMismatch(ExperimentPrototype):
    ...
    def __init__(self):
        ...
        # changed from 10e3/3->10e3
        decimation_scheme = DecimationScheme(
            rates[0], rates[-2] / dm_rates[-1], stages=all_stages
        )
...
class FirstStageBadInputRate(ExperimentPrototype):
    ...
    def __init__(self):
        ...
        # changed from 10e3/3->10e3
        decimation_scheme = DecimationScheme(
            5.001e6, rates[-2] / dm_rates[-1], stages=all_stages
        )
...
class FilterTapsNotList(ExperimentPrototype):
    ...
    def __init__(self):
        ...
        for stage in range(0, len(rates)):
            ...
            all_stages.append(
                DecimationStage(stage, rates[stage], dm_rates[stage], set(filter_taps))
            )
...
class FilterTapsNotNums(ExperimentPrototype):
    ...
    def __init__(self):
        ...
        for stage in range(0, len(rates)):
            ...
            all_stages.append(
                DecimationStage(
                    stage, rates[stage], dm_rates[stage], [str(x) for x in filter_taps]
                )
            )
...
class TooManyFilterStages(ExperimentPrototype):
    ...
    def __init__(self):
        rates = [
            ...
            62.5e3,
            31.25e3,
        ]  # 7 stages, greater than max of 6
